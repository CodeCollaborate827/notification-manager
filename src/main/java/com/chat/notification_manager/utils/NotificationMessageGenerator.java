...
public class NotificationMessageGenerator {
    ...
    public static String generateTitle(NotificationType type, User fromUser, Conversation conversation) {
    ...
    public static String generateContent(NotificationType type, User fromUser, Conversation conversation) {
        String displayName = (fromUser != null && fromUser.getDisplayName() != null)
                ? fromUser.getDisplayName()
                : "Someone";
        String conversationName = (conversation != null && conversation.getConversationName() != null)
        ...
        switch (type) {
            case NEW_FRIEND:
                return displayName + " wants to connect with you. Click to view their profile and accept the request.";
            case MESSAGE_MENTIONED:
                return "You were mentioned by " + displayName + " in " + conversationName + ". Tap to view the message.";
            case MESSAGE_REACTED:
                return displayName + " reacted to your message in " + conversationName + ". Tap to view the conversation.";
            default:
